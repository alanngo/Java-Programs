...
public class OddOccurences
{
    ...
    */
    ...
    private static Map <Integer, Integer> cache = new HashMap<>(); //index->occurrence
    private static int binarySearch(int [] arr, int key, int first, int last)
    {
    ...
    private static int countOccurences(int [] arr, int key)
    {
        ...
        //count on right side
        int right = index +1;
        while (arr[right]==key && right<arr.length)
        {
            count++;
            right++;
        }
